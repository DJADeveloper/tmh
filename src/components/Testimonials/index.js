    ...
    review: [
      {
        ...
        comment:
          "In a world where the right partnership can make all the difference, Mastery House emerges as a beacon for businesses big and small, driving growth, innovation, and success in equal measure.",
      },
    ],
  },
  {
    ...
    review: [
      {
        ...
        image: "/images/content/trainer-pic.png",
        image2x: "/images/content/trainer-pic@2x.png",
        comment: "The Mastery House is the greatest fitness app. ",
      },
    ],
  },
  {
    ...
    review: [
      {
        ...
        image2x: "/images/content/trainer-pic@2x.png",
        comment:
          "The Mastery House is the greatest fitness app. It's clear the makers behind this thing use it every week, because it is so perfect.",
      },
    ],
  },
  {
